...
namespace TMPro
{
    ...
    public class TMP_Text : MaskableGraphic
    {
        ...
        {
            get { return m_margin; }
            set { /* if (m_margin != value) */ { m_margin = value; /* Debug.Log("Margin is " + margin); ComputeMarginSize();*/ m_havePropertiesChanged = true; SetVerticesDirty(); } }
        }
        [SerializeField]
        ...
        protected bool m_verticesDirty;
        ...
        protected void SaveSpriteVertexInfo(float padding, float style_padding, Color32 vertexColor)
        {
